...
CREATE TABLE IF NOT EXISTS `zt_baseimage` (
  ...
  `suggestCore` smallint(0) NOT NULL DEFAULT 0,
  `suggestMemory` smallint(0) NOT NULL DEFAULT 0,
  `suggestVolume` smallint(0) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS `zt_baseimagebrowser` (
  `vmBackingID` int(0) NOT NULL,
  `browserID` int(0) NOT NULL,
...
CREATE TABLE `zt_doc` (
  ...
  `fromVersion` smallint(6) unsigned NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `zt_gapanalysis` (
  ...
  `needTrain` enum('0','1') NOT NULL DEFAULT '0',
  `createdBy` char(30),
  `createdDate` datetime NOT NULL,
  `editedBy` varchar(30) NOT NULL,
  `editedDate` datetime NOT NULL,
...
CREATE TABLE `zt_host` (
  ...
  `pri` smallint(0) NOT NULL DEFAULT 0,
  `heartbeatTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `zt_story` (
  ...
  `fromVersion` mediumint(8) unsigned NOT NULL DEFAULT 0,
  `openedBy` varchar(30) NOT NULL DEFAULT '',
  `openedDate` datetime NOT NULL,
  `assignedTo` varchar(30) NOT NULL DEFAULT '',
  `assignedDate` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zt_vm` (
  `id` int(0) unsigned NOT NULL AUTO_INCREMENT,
  `hostID` int(0) unsigned NOT NULL DEFAULT 0,
  `name` varchar(255) NOT NULL DEFAULT '',
  `osCategory` varchar(50) NOT NULL DEFAULT '',
  `osType` varchar(50) NOT NULL DEFAULT '',
  `osArch` varchar(50) NOT NULL DEFAULT '',
  ...
  `templateID` int(0) unsigned NOT NULL DEFAULT 0,
  `baseImageID` int(0) unsigned NOT NULL DEFAULT 0,
