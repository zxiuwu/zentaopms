...
$lang->action->trashAction    = '資源回收筒列表';
$lang->action->undeleteAction = '還原數據';
$lang->action->hideOneAction  = '隱藏數據';

$lang->action->refusecase  = '還原用例之前，請先還原該用例所屬場景';
$lang->action->refusescene = '還原場景之前，請先還原該場景的父場景';
...
$lang->action->executionNoProject = "該執行沒有所屬的{$lang->projectCommon}，請先還原{$lang->projectCommon}再還原執行";
$lang->action->repoNoServer       = '該代碼庫沒有所屬的伺服器，請先還原伺服器再還原代碼庫';
$lang->action->hasCreatedTask     = '該父階段已創建任務，無法恢復！';
$lang->action->hasDeletedParent   = '恢復該階段需要同時恢復已刪除的父階段%s，';
$lang->action->hasChangedAttr     = '恢復後階段類型將根據父階段類型均調整為“%s”，';
$lang->action->whetherToRestore   = '是否恢復？';

$lang->action->hasOtherType = array();
$lang->action->hasOtherType['stage']  = "當前階段的父級現在只允許創建{$lang->executionCommon}/看板類型的子級,故無法恢復當前階段。";
$lang->action->hasOtherType['sprint'] = "當前{$lang->executionCommon}的父級現在只允許創建階段類型的子級,故無法恢復當前{$lang->executionCommon}。";
$lang->action->hasOtherType['kanban'] = "當前看板的父級現在只允許創建階段類型的子級,故無法恢復當前看板。";

$lang->action->repeatChange     = '系統內已有同名、同代號的%s，恢復後名稱為\"%s\"、代號為\"%s\"。';
$lang->action->nameRepeatChange = '系統內已有同名的%s，恢復後名稱為\"%s\"。';
$lang->action->codeRepeatChange = '系統內已有同代號的%s，恢復後代號為\"%s\"。';
...
$lang->action->objectTypes['job']              = '流水綫';
...
$lang->action->objectTypes['zahost']           = '宿主機';
$lang->action->objectTypes['zanode']           = '執行節點';
...
$lang->action->objectTypes['pipeline']         = 'GitLab伺服器';
$lang->action->objectTypes['gitlab']           = 'GitLab伺服器';
$lang->action->objectTypes['gitea']            = 'Gitea伺服器';
$lang->action->objectTypes['gogs']             = 'Gogs伺服器';
...
$lang->action->objectTypes['gogsuser']         = 'Gogs用戶';
...
$lang->action->objectTypes['stage']            = '階段';
$lang->action->objectTypes['patch']            = '補丁';
$lang->action->objectTypes['repo']             = '代碼庫';
$lang->action->objectTypes['dataview']         = '中間表';
$lang->action->objectTypes['privlang']         = '權限';
$lang->action->objectTypes['scene']            = '場景';
$lang->action->objectTypes['serverroom']       = '機房';
$lang->action->objectTypes['account']          = '賬號';
$lang->action->objectTypes['host']             = '主機';
$lang->action->objectTypes['deploy']           = '發佈';
$lang->action->objectTypes['service']          = '服務';
$lang->action->objectTypes['domain']           = '域名';
$lang->action->objectTypes['artifactrepo']     = '製品庫';
$lang->action->objectTypes['prompt']           = '提詞';
...
$lang->action->desc->moved                = '$date, 由 <strong>$actor</strong> 移動。' . "\n";
...
$lang->action->desc->syncprogram          = '$date, 由 <strong>$actor</strong> 啟動(因' . $lang->projectCommon . '開始而啟動項目集)。' . "\n";
$lang->action->desc->syncproject          = '$date, 系統判斷由於' . $lang->executionCommon .'開始，將' . $lang->projectCommon . '狀態置為進行中。' . "\n";
$lang->action->desc->syncmultipleproject  = '$date, 系統判斷由於任務開始，將' . $lang->projectCommon . '狀態置為進行中。' . "\n";
$lang->action->desc->syncexecution        = '$date, 系統判斷由於任務開始，將' . $lang->executionCommon . '狀態置為進行中。' . "\n";
$lang->action->desc->syncexecutionbychild = '$date, 系統判斷由於子階段開始，將' . $lang->executionCommon . '狀態置為進行中。' . "\n";
...
$lang->action->desc->importedproductplan  = '$date, 由 <strong>$actor</strong> 從' . $lang->productCommon . '計劃 <strong>$extra</strong> 導入。' . "\n";
$lang->action->desc->importedrelease      = '$date, 由 <strong>$actor</strong> 從' . $lang->productCommon . '發佈 <strong>$extra</strong> 導入。' . "\n";
$lang->action->desc->importedexecution    = '$date, 由 <strong>$actor</strong> 從' . $lang->projectCommon . '執行 <strong>$extra</strong> 導入。' . "\n";
$lang->action->desc->importedbuild        = '$date, 由 <strong>$actor</strong> 從' . $lang->projectCommon . '版本 <strong>$extra</strong> 導入。' . "\n";
$lang->action->desc->importedticket       = '$date, 由 <strong>$actor</strong> 從反饋工單 <strong>$extra</strong> 導入。' . "\n";
$lang->action->desc->fromsonarqube        = '$date, 由 <strong>$actor</strong> 從<strong>SonarQube問題</strong>轉化而來。' . "\n";
$lang->action->desc->tolib                = '$date, 由 <strong>$actor</strong> 導入。' . "\n";
$lang->action->desc->updatetolib          = '$date, 由 <strong>$actor</strong> 從' . $lang->testcase->common . '更新。' . "\n";
$lang->action->desc->adjusttasktowait     = '$date, 系統判斷由於消耗工時調整為0，將任務狀態置為未開始。' . "\n";
$lang->action->desc->reopen               = '$date, 由 <strong>$actor</strong> 重新打開。' . "\n";
$lang->action->desc->merged               = '$date, 由 <strong>$actor</strong> 合併。' . "\n";
$lang->action->desc->submitreview         = '$date, 由 <strong>$actor</strong> 提交評審。' . "\n";
...
$lang->action->desc->destroy              = '$date, 由 <strong>$actor</strong> 關閉。' . "\n";
$lang->action->desc->boot                 = '$date, 由 <strong>$actor</strong> 啟動。' . "\n";
$lang->action->desc->relieved             = '$date, 由 <strong>$actor</strong> 解除孿生需求關係。' . "\n";
$lang->action->desc->switchtolight        = '$date, 由於 <strong>'. $lang->admin->system .'</strong> 從全生命周期管理模式切換為輕量管理模式，' . $lang->projectCommon . '訪問控制由項目集內公開調整為私有。' . "\n";
$lang->action->desc->getvnc               = '$date, <strong>$actor</strong>對執行節點 <strong>$extra</strong> 進行了遠程操控。' . "\n";
$lang->action->desc->unlinkproduct        = '$date, 系統判斷由於' . $lang->executionCommon . '所屬' . $lang->projectCommon . '與$extra取消關聯，同步將' . $lang->executionCommon . '與$extra取消關聯。' . "\n";
$lang->action->desc->createdsnapshot      = '$date, <strong>$actor</strong> 創建了快照 <strong>$extra</strong>。' . "\n";
$lang->action->desc->restoredsnapshot     = '$date, <strong>$actor</strong> 還原了快照 <strong>$extra</strong>。' . "\n";
$lang->action->desc->editsnapshot         = '$date, <strong>$actor</strong> 編輯了快照 <strong>$extra</strong>。' . "\n";
$lang->action->desc->deletesnapshot       = '$date, <strong>$actor</strong> 刪除了快照 <strong>$extra</strong>。' . "\n";
...
/* 用來描述計劃關聯和移除需求、bug時的歷史操作記錄。*/
$lang->action->desc->linkstory   = '$date, 由 <strong>$actor</strong> 關聯需求 <strong>$extra</strong>。' . "\n";
$lang->action->desc->linkbug     = '$date, 由 <strong>$actor</strong> 關聯BUG <strong>$extra</strong>。' . "\n";
$lang->action->desc->unlinkstory = '$date, 由 <strong>$actor</strong> 從計劃移除需求 <strong>$extra</strong>。' . "\n";
$lang->action->desc->unlinkbug   = '$date, 由 <strong>$actor</strong> 從計劃移除BUG <strong>$extra</strong>。' . "\n";

/* 用來描述文檔保存為草稿或發佈時的歷史操作記錄。*/
$lang->action->desc->saveddraft  = '$date, 由 <strong>$actor</strong> 存為草稿 <strong>$extra</strong>。' . "\n";
$lang->action->desc->releaseddoc = '$date, 由 <strong>$actor</strong> 發佈 <strong>$extra</strong>。' . "\n";

/* 用來描述文檔收藏或取消收藏時的歷史操作記錄。*/
...
/* 用來描述應用的歷史操作記錄。*/
$lang->action->desc->install                 = '$date, 由 <strong>$actor</strong> 安裝。' . "\n";
$lang->action->desc->uninstall               = '$date, 由 <strong>$actor</strong> 刪除。' . "\n";
$lang->action->desc->start                   = '$date, 由 <strong>$actor</strong> 啟動。' . "\n";
$lang->action->desc->stop                    = '$date, 由 <strong>$actor</strong> 關閉。' . "\n";
$lang->action->desc->editname                = '$date, 由 <strong>$actor</strong> 修改了名稱，從 <strong>$oldName</strong> 修改為 <strong>$newName</strong> 。' . "\n";
$lang->action->desc->upgrade                 = '$date, 由 <strong>$actor</strong> 升級，從 <strong>$oldVersion</strong> 升級為 <strong>$newVersion</strong> 。' . "\n";
$lang->action->desc->backup                  = '$date, 由 <strong>$actor</strong> 備份。' . "\n";
$lang->action->desc->adjustmemory            = '$date, 由 <strong>$actor</strong> 調整內存到 <strong>$newMemory</strong> 。' . "\n";
$lang->action->desc->enableldap              = '$date, 由 <strong>$actor</strong> 啟用了LDAP。' . "\n";
$lang->action->desc->disableldap             = '$date, 由 <strong>$actor</strong> 禁用了LDAP。' . "\n";
$lang->action->desc->enablesmtp              = '$date, 由 <strong>$actor</strong> 啟用了SMTP。' . "\n";
$lang->action->desc->disablesmtp             = '$date, 由 <strong>$actor</strong> 禁用了SMTP。' . "\n";
$lang->action->desc->updatecustom            = '$date, 由 <strong>$actor</strong> 修改了自定義配置。' . "\n";
$lang->action->desc->tosenior                = '$date, 由 <strong>$actor</strong> 升級服務到高級版，從 <strong>$oldAppName</strong> 升級到 <strong>$newAppName</strong> 。' . "\n";
$lang->action->desc->saveautobackupsettings  = '$date, 由 <strong>$actor</strong> 修改了自動備份設置：開啟自動備份。' . "\n";
$lang->action->desc->closeautobackupsettings = '$date, 由 <strong>$actor</strong> 修改了自動備份設置：自動備份已關閉。' . "\n";
$lang->action->desc->saveautorestoresettings = '$date, 由 <strong>$actor</strong> 修改了自動還原設置。' . "\n";
$lang->action->desc->autobackup              = '$date, 系統執行了自動備份。' . "\n";
$lang->action->desc->autorestore             = '$date, 系統執行了自動還原。' . "\n";
$lang->action->desc->deleteexpiredbackup     = '$date, 系統刪除了過期的自動備份。' . "\n";

$lang->action->desc->delist  = '$date, 由 <strong>$actor</strong> 下架。' . "\n";
$lang->action->desc->publish = '$date, 由 <strong>$actor</strong> 發佈。' . "\n";

/* 用來顯示動態信息。*/
$lang->action->label = new stdclass();
$lang->action->label->install                 = '安裝了';
$lang->action->label->uninstall               = '刪除了';
$lang->action->label->upgrade                 = '升級了';
$lang->action->label->start                   = '啟動了';
$lang->action->label->stop                    = '關閉了';
$lang->action->label->editname                = '修改了名稱';
$lang->action->label->backup                  = '備份了';
$lang->action->label->adjustmemory            = '調整了內存';
$lang->action->label->enableldap              = '啟用了LDAP';
$lang->action->label->disableldap             = '禁用了LDAP';
$lang->action->label->enablesmtp              = '啟用了SMTP';
$lang->action->label->disablesmtp             = '禁用了SMTP';
$lang->action->label->tosenior                = '升級了高級版';
$lang->action->label->saveautobackupsettings  = '開啟了自動備份';
$lang->action->label->closeautobackupsettings = '關閉了自動備份';
$lang->action->label->autobackup              = '系統執行了自動備份';
$lang->action->label->autorestore             = '系統執行了自動還原';
$lang->action->label->deleteexpiredbackup     = '系統刪除了過期的自動備份';
$lang->action->label->revert                  = '還原了';
$lang->action->label->created                 = '創建了';
$lang->action->label->opened                  = '創建了';
$lang->action->label->openedbysystem          = '系統創建了';
$lang->action->label->closedbysystem          = '系統關閉了';
...
$lang->action->label->deletedfile             = '刪除了附件';
$lang->action->label->editfile                = '編輯了附件';
...
$lang->action->label->recalled                = '撤銷了評審';
$lang->action->label->recalledchange          = '撤銷了變更';
$lang->action->label->moved                   = '移動了';
$lang->action->label->confirmed               = "確認了{$lang->SRCommon}";
$lang->action->label->bugconfirmed            = '確認了';
$lang->action->label->tostory                 = "轉了{$lang->SRCommon}";
$lang->action->label->frombug                 = "轉了{$lang->SRCommon}";
$lang->action->label->fromlib                 = '從用例庫導入';
$lang->action->label->totask                  = '轉了任務';
$lang->action->label->converttotask           = '轉了任務';
$lang->action->label->svncommited             = '提交了代碼';
$lang->action->label->gitcommited             = '提交了代碼';
$lang->action->label->linked2plan             = "關聯了計劃";
$lang->action->label->unlinkedfromplan        = "移除了計劃";
$lang->action->label->changestatus            = '修改了狀態';
$lang->action->label->marked                  = '編輯了';
$lang->action->label->linked2execution        = "關聯了{$lang->executionCommon}";
$lang->action->label->unlinkedfromexecution   = "移除了{$lang->executionCommon}";
$lang->action->label->linked2kanban           = '關聯了看板';
$lang->action->label->linked2project          = "關聯了{$lang->projectCommon}";
$lang->action->label->unlinkedfromproject     = "移除了{$lang->projectCommon}";
$lang->action->label->unlinkedfrombuild       = "移除了版本";
$lang->action->label->linked2release          = "關聯了發佈";
$lang->action->label->unlinkedfromrelease     = "移除了發佈";
$lang->action->label->linked2revision         = "關聯了代碼提交";
$lang->action->label->unlinkedfromrevision    = "取消關聯了代碼提交";
...
$lang->action->label->suspended               = '掛起了';
...
$lang->action->label->linkchildtask           = "關聯了子任務";
$lang->action->label->unlinkchildrentask      = "取消關聯了子任務";
$lang->action->label->linkparenttask          = "關聯到了父任務";
$lang->action->label->unlinkparenttask        = "從父任務取消關聯了";
$lang->action->label->batchcreate             = "批量創建了任務";
$lang->action->label->createchildren          = "創建了子任務";
$lang->action->label->managed                 = "維護了";
$lang->action->label->managedteam             = "維護了";
$lang->action->label->managedwhitelist        = "維護了";
$lang->action->label->deletechildrentask      = "刪除了子任務";
$lang->action->label->createchildrenstory     = "創建了子需求";
$lang->action->label->linkchildstory          = "關聯了子需求";
$lang->action->label->unlinkchildrenstory     = "取消關聯了子需求";
$lang->action->label->linkparentstory         = "關聯到了父需求";
$lang->action->label->unlinkparentstory       = "從父需求取消關聯了";
$lang->action->label->deletechildrenstory     = "刪除了子需求";
...
$lang->action->label->reviewrejected          = '拒絶了';
$lang->action->label->reviewclarified         = '有待明確';
$lang->action->label->reviewreverted          = '撤銷變更';
$lang->action->label->commitsummary           = '提交了培訓總結';
$lang->action->label->updatetrainee           = '更新了培訓人員';
...
$lang->action->label->syncexecutionbychild    = '開始了';
$lang->action->label->startProgram            = "（因{$lang->projectCommon}開始而啟動項目集）";
...
$lang->action->label->reopen                  = '重新打開了';
...
$lang->action->label->mergedbranch            = '合併了分支';
...
$lang->action->label->importedticket          = '導入了';
$lang->action->label->fromsonarqube           = '由SonarQube問題創建了';
$lang->action->label->bind                    = '綁定了';
$lang->action->label->unbind                  = '取消綁定了';
$lang->action->label->linkstory               = '關聯需求到了';
$lang->action->label->linkbug                 = '關聯BUG到了';
$lang->action->label->unlinkstory             = '移除了需求從';
$lang->action->label->unlinkbug               = '移除了BUG從';
$lang->action->label->tolib                   = '導入了';
$lang->action->label->updatetolib             = '更新了';
$lang->action->label->ganttmove               = '排序了';
$lang->action->label->submitreview            = '提交了評審';
$lang->action->label->suspend                 = '休眠了';
$lang->action->label->resume                  = '恢復了';
$lang->action->label->reboot                  = '重啟了';
$lang->action->label->boot                    = '啟動了';
$lang->action->label->destroy                 = '關閉了';
$lang->action->label->getvnc                  = '遠程操控了';
$lang->action->label->synctwins               = '同步修改了';
$lang->action->label->relieved                = '解除了';
$lang->action->label->switchtolight           = '從全生命周期管理模式切換為輕量管理模式';
$lang->action->label->linkedrepo              = '關聯代碼庫到';
$lang->action->label->unlinkedrepo            = "取消了{$lang->projectCommon}與代碼庫的關聯";
$lang->action->label->unlinkproduct           = "取消了與{$lang->productCommon}的關聯";
$lang->action->label->createdsnapshot         = '創建了快照';
$lang->action->label->restoredsnapshot        = '還原了快照';
$lang->action->label->editsnapshot            = '編輯了快照';
$lang->action->label->deletesnapshot          = '編輯了快照';
$lang->action->label->saveddraft              = '存為草稿';
$lang->action->label->releaseddoc             = '發佈了';
...
$lang->action->label->published               = '發佈了';
$lang->action->label->unpublished             = '下架了';
$lang->action->label->prompt                  = '提詞';
...
$lang->action->dynamicAction->project['switchtolight'] = '切換模式';
...
$lang->action->dynamicAction->productplan['linkstory']   = "關聯需求";
$lang->action->dynamicAction->productplan['unlinkstory'] = "移除需求";
$lang->action->dynamicAction->productplan['linkbug']     = "關聯BUG";
...
$lang->action->dynamicAction->story['linked2revision']       = "{$lang->SRCommon}關聯代碼提交";
$lang->action->dynamicAction->story['unlinkedfromrevision']  = "{$lang->SRCommon}取消關聯代碼提交";
...
$lang->action->dynamicAction->story['linked2kanban']         = "關聯$lang->SRCommon";
...
$lang->action->dynamicAction->task['linked2revision']      = '任務關聯代碼提交';
$lang->action->dynamicAction->task['unlinkedfromrevision'] = '任務取消關聯代碼提交';
...
$lang->action->dynamicAction->bug['linked2revision']      = 'Bug關聯代碼提交';
$lang->action->dynamicAction->bug['unlinkedfromrevision'] = 'Bug取消關聯代碼提交';
...
$lang->action->dynamicAction->case['tolib']       = '導入';
...
$lang->action->dynamicAction->zahost['created'] = '創建宿主機';

$lang->action->dynamicAction->zanode['created'] = '創建執行節點';
$lang->action->dynamicAction->zanode['suspend'] = '休眠執行節點';
$lang->action->dynamicAction->zanode['resume']  = '恢復執行節點';
$lang->action->dynamicAction->zanode['reboot']  = '重啟執行節點';
$lang->action->dynamicAction->zanode['boot']    = '啟動執行節點';
$lang->action->dynamicAction->zanode['destroy'] = '關閉執行節點';
...
$lang->action->dynamicAction->sonarqube['undeleted'] = '還原SonarQube伺服器';

$lang->action->dynamicAction->sonarqubeproject['deleted'] = '刪除SonarQube項目';

$lang->action->dynamicAction->gitlab['created']   = '創建GitLab伺服器';
$lang->action->dynamicAction->gitlab['edited']    = '編輯GitLab伺服器';
$lang->action->dynamicAction->gitlab['deleted']   = '刪除GitLab伺服器';
$lang->action->dynamicAction->gitlab['undeleted'] = '還原GitLab伺服器';

$lang->action->dynamicAction->gitea['created']   = '創建Gitea伺服器';
$lang->action->dynamicAction->gitea['edited']    = '編輯Gitea伺服器';
$lang->action->dynamicAction->gitea['deleted']   = '刪除Gitea伺服器';
$lang->action->dynamicAction->gitea['undeleted'] = '還原Gitea伺服器';

$lang->action->dynamicAction->gogs['created']   = '創建Gogs伺服器';
$lang->action->dynamicAction->gogs['edited']    = '編輯Gogs伺服器';
$lang->action->dynamicAction->gogs['deleted']   = '刪除Gogs伺服器';
$lang->action->dynamicAction->gogs['undeleted'] = '還原Gogs伺服器';

$lang->action->dynamicAction->repo['created']   = '創建代碼庫';
$lang->action->dynamicAction->repo['edited']    = '編輯代碼庫';
$lang->action->dynamicAction->repo['deleted']   = '刪除代碼庫';
$lang->action->dynamicAction->repo['undeleted'] = '還原代碼庫';

$lang->action->dynamicAction->ai['created']     = '創建提詞';
$lang->action->dynamicAction->ai['edited']      = '編輯提詞';
$lang->action->dynamicAction->ai['published']   = '發佈提詞';
$lang->action->dynamicAction->ai['unpublished'] = '下架提詞';

$lang->action->dynamicAction->metric['created']   = '創建度量';
$lang->action->dynamicAction->metric['edited']    = '編輯度量';
$lang->action->dynamicAction->metric['deleted']   = '刪除度量';
$lang->action->dynamicAction->metric['undeleted'] = '還原度量';
$lang->action->dynamicAction->metric['delist']    = '下架度量';
$lang->action->dynamicAction->metric['publish']   = '發佈度量';
...
$lang->action->label->doclib       = '文檔庫|doc|teamspace|objectID=%s&libID=%s';
...
$lang->action->label->api          = '介面|api|view|libID=%s&apiID=%s&moduleID=%s';
...
$lang->action->label->gitlab       = 'GitLab伺服器|gitlab|view|id=%s';
$lang->action->label->stage        = '瀑布模型的階段|stage|browse|';
$lang->action->label->module       = '模組|tree|browse|productid=%s&type=story&currentModuleID=0&branch=all';
$lang->action->label->ticket       = '工單|ticket|view|id=%s';
$lang->action->label->chartgroup   = '分組';
...
$lang->action->label->instance     = '應用|instance|view|id=%s';
$lang->action->label->deploy       = '上線|deploy|view|id=%s';
$lang->action->label->domian       = '域名|domian|view|id=%s';
$lang->action->label->service      = '服務|service|view|id=%s';
$lang->action->label->artifactrepo = '製品庫|artifactrepo|browse|';
$lang->action->label->prompt       = '提詞|ai|promptview|id=%s';
...
$lang->action->apiTitle->linked2kanban         = '關聯看板';
$lang->action->apiTitle->linked2project        = "關聯{$lang->projectCommon}";
...
$lang->action->apiTitle->linked2revision       = "關聯代碼提交";
$lang->action->apiTitle->unlinkedfromrevision  = "取消關聯代碼提交";
...
$lang->action->desc->deletemr                     = '$date, 由 <strong>$actor</strong> 取消關聯了 <a href="$extra">合併請求</a>。';
...
$lang->action->desc->linkedrepo                   = '$date, 由 <strong>$actor</strong> 關聯代碼庫 $extra';
$lang->action->desc->unlinkedrepo                 = '$date, 由 <strong>$actor</strong> 取消了' . $lang->projectCommon . '與代碼庫 $extra 的關聯';
