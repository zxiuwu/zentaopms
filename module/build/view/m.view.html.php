  ...
  <div class='section no-margin'>
    <div class='outline'>
      <nav class="nav" data-display="" data-selector="a" data-show-single="true" data-active-class="active" data-animate="false">
        ...
        <a class='<?php if($type == 'generatedBug') echo 'active'?>' data-target="#generatedBugs"><?php echo $lang->build->generatedBugs?></a>
      ...
      <div>
        ...
        <div class="display <?php echo $type == 'bug' ? 'in' : 'hidden'?>" id="bugs">
          ...
          <nav class='nav justified pager'>
            ...
            $bugPager->show($align = 'justify');
            $this->app->rawParams['type'] = $type;
            ?>
          </nav>
        </div>
        <div class="display <?php echo $type == 'generatedBug' ? 'in' : 'hidden'?>" id="generatedBugs">
          <table class='table bordered'>
            <thead>
              <tr>
                <th class='w-60px'><?php echo $lang->idAB;?></th>
          ...
          <nav class='nav justified pager'>
            ...
            $generatedBugPager->show($align = 'justify');
            $this->app->rawParams['type'] = $type;
            ?>
          </nav>
        </div>
