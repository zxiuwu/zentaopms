<?php
/**
 * The close mobile view file of bug module of ZenTaoPMS.
 *
...
<div class='heading divider'>
  <span class='title'><strong><?php echo $lang->bug->close ?></strong> #<?php echo $bug->id ?></span>
  <nav class='nav'>
    <a data-dismiss='display'><i class='icon-remove muted'></i></a>
  </nav>
</div>
<form class='has-padding content' method='post' target='hiddenwin' action='<?php echo $this->createLink('bug', 'close', "id=$bug->id")?>' id='closeForm' data-form-refresh='#page'>
  <div class='control'>
