...
$lang->host->view         = '主機詳情';
$lang->host->edit         = '編輯';
$lang->host->editAction   = '編輯主機';
$lang->host->delete       = '刪除';
$lang->host->deleteAction = '刪除主機';
$lang->host->treemap      = '主機拓撲圖';
...
$lang->host->name         = '名稱';
$lang->host->type         = '類型';
$lang->host->hardwareType = '硬件類型';
$lang->host->group        = '主機分組';
$lang->host->admin        = '管理賬號';
...
$lang->host->featureBar['browse']['serverroom'] = '物理拓撲圖';
$lang->host->featureBar['browse']['group']      = '分組拓撲圖';
...
$lang->host->zap         = 'agent連接埠';
$lang->host->instanceNum = '最大實列數';
$lang->host->pri         = '優先順序';
$lang->host->tags        = '平台標籤';
$lang->host->provider    = '供應商';
$lang->host->bridgeID    = '虛擬網橋';
...
$lang->host->notice->int       = '『%s』應當是正整數！';
$lang->host->notice->ip        = '『%s』格式不正確！';
