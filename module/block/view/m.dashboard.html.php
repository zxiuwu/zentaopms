<style>
tbody > tr > td{word-wrap: break-word; word-break: normal;}
</style>
<div id='blocks' class='blocks'>
  ...
  <?php if(strpos(',statistic,team,overview,welcome,flowchart,calendar,report,', ",{$block->block},") !== false) continue; ?>
  ...
  <div class='section' id='block<?php echo $block->id ?>' data-code='<?php echo $block->block ?>' data-id='<?php echo $index ?>' data-url='<?php echo $block->blockLink;?>'>
    ...
    <?php endif; ?>
    <div class='content listen-scroll<?php if($block->block == 'html') echo ' article has-padding'; ?>' data-display='self'>
