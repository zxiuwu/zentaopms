...
$lang->gitlab->placeholderSearch = '請輸入名稱';
...
$lang->gitlab->browseProject        = "GitLab項目列表";
$lang->gitlab->browseUser           = "用戶";
$lang->gitlab->browseGroup          = "GitLab群組列表";
$lang->gitlab->browseBranch         = "GitLab分支列表";
$lang->gitlab->browseTag            = "GitLab標籤列表";
$lang->gitlab->browseTagPriv        = "標籤保護管理";
...
$lang->gitlab->svaeFailed           = '『%s』保存失敗';

$lang->gitlab->id             = 'ID';
$lang->gitlab->name           = "應用名稱";
$lang->gitlab->url            = '伺服器地址';
$lang->gitlab->token          = 'Token';
$lang->gitlab->defaultProject = '預設項目';
$lang->gitlab->private        = 'MD5驗證';

$lang->gitlab->server        = "伺服器列表";
...
$lang->gitlab->mustBindUser  = '您還未綁定GitLab用戶，請聯繫管理員進行綁定';
$lang->gitlab->noAccess      = '權限不足';
$lang->gitlab->notCompatible = '當前GitLab版本與禪道不兼容，請升級GitLab版本後重試';
$lang->gitlab->deleted       = '已刪除';
...
$lang->gitlab->placeholder->token       = "請填寫具有root權限賬戶的access token";
...
$lang->gitlab->tokenError         = "當前token非root權限。";
$lang->gitlab->tokenLimit         = "GitLab Token權限不足。請更換為有root權限的GitLab Token。";
$lang->gitlab->hostError          = "當前GitLab伺服器地址無效或當前GitLab版本與禪道不兼容，請確認當前伺服器可被訪問或聯繫管理員升級GitLab至%s及以上版本後重試";
...
$lang->gitlab->apiError[6] = 'Failed to save group {:path=>["已經被使用"]}';
...
$lang->gitlab->errorLang[8] = '格式錯誤';
$lang->gitlab->errorLang[9] = 'admin是保留名';

$lang->gitlab->errorResonse['Email has already been taken']    = '郵箱已存在';
$lang->gitlab->errorResonse['Username has already been taken'] = '用戶名已存在';
...
$lang->gitlab->project->publicTip                  = '當前項目的可見性級別將修改為公開，該項目可以在GitLab中沒有任何身份驗證的情況下被訪問';
...
$lang->gitlab->group->publicTip                               = '當前群組的可見性級別將修改為公開，該群組可以在GitLab中沒有任何身份驗證的情況下被訪問';
...
$lang->gitlab->branch->mergeAllowed                = "允許合併";
$lang->gitlab->branch->pushAllowed                 = "允許推送";
...
$lang->gitlab->tag->protectConfirmDel  = '確認刪除該GitLab標籤保護嗎？';
$lang->gitlab->tag->emptyPrivNameError = "標籤不能為空";
$lang->gitlab->tag->issetPrivNameError = "已存在該保護標籤";
