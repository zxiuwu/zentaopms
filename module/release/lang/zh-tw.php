...
$lang->release->syncFromBuilds     = "將版本中完成的{$lang->SRCommon}和已解決的Bug關聯到發佈下";
...
$lang->release->pageAllSummary = '本頁共 <strong>%total%</strong> 個發佈，正常 <strong>%normal%</strong>，停止維護 <strong>%terminate%</strong>。';
