<?php
$lang->report->crystalExport = '导出单一模板';
$lang->report->null          = '空';
...
$lang->crystal->execution    = '执行';
$lang->crystal->allProject   = '全部' . $lang->projectCommon;
$lang->crystal->allExecution = '全部执行';
...
$lang->crystal->requestTypeList['datetime'] = '时间';
...
$lang->report->useReportAction  = '设计单一模板';
$lang->report->browseReport     = '浏览保存模板';
$lang->report->deleteReport     = '删除单一模板';
$lang->report->editReport       = '编辑';
$lang->report->editReportAction = '编辑单一模板';
$lang->report->saveReport       = '保存单一模板';
$lang->report->show             = '查看单一模板';

$lang->report->statisticLangList['project']   = $lang->projectCommon . '列表';
$lang->report->statisticLangList['product']   = $lang->productCommon;
$lang->report->statisticLangList['dept']      = '部门';
$lang->report->statisticLangList['execution'] = '执行列表';
$lang->report->statisticLangList['status']    = '状态';
$lang->report->statisticLangList['beginDate'] = '起始时间';
$lang->report->statisticLangList['startDate'] = '起始时间';
$lang->report->statisticLangList['endDate']   = '结束时间';
...
$lang->report->projectStatusList['pause']  = '已暂停';
