<?php
/**
 * The view mobile view file of trip module of ZDOO.
 *
...
<div id='page' class='list-with-actions'>
  <div class='section'>
    <div class='heading gray'>
      <div class='title'><i class='icon-calendar'> </i><?php echo $lang->$type->view;?></div>
  ...
  <nav class='nav affix dock-bottom nav-auto footer-actions'>
    ...
    <a data-remote='<?php echo $this->createLink("$type", 'edit', "id={$trip->id}");?>' data-display='modal' data-placement='bottom'><?php echo $lang->edit;?></a>
    <a data-remote='<?php echo $this->createLink("$type", 'delete', "id=$trip->id");?>' data-display='ajaxAction' data-ajax-delete='true' data-locate='<?php echo $this->createLink("$type", 'browse');?>'><?php echo $lang->delete;?></a>
    <?php endif;?>
  </nav>
</div>
