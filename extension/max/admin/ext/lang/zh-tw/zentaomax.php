...
$lang->admin->menuList->template['subMenu']['type']     = array('link' => "模板類型|baseline|templateType|", 'alias' => 'templatetype');
$lang->admin->menuList->template['subMenu']['template'] = array('link' => "文檔模板|baseline|template|", 'alias' => 'createtemplate,edittemplate,managebook,view,editbook');
