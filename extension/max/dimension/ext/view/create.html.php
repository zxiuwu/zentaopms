 ...
 * @package     dimension
 * @version     $Id: create.html.php 4129 2022-11-1 13:28:02Z $
...
<div id='mainContent' class='main-content'>
  <div class='center-block'>
    <div class='main-header'>
      <h2><?php echo $lang->dimension->create;?></h2>
    </div>
    <form class='form-indicator main-form form-ajax' method='post' target='hiddenwin' id='dataform'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td>
            <?php echo html::input('code', '', "class='form-control' placeholder='{$lang->dimension->codeHolder}'");?>
          </td>
        </tr>
        <tr>
