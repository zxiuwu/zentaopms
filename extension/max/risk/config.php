...
$config->risk->editor->hangup   = array('id' => 'comment', 'tools' => 'simpleTools');
$config->risk->editor->activate = array('id' => 'comment', 'tools' => 'simpleTools');
...
$config->risk->search['fields']['editedBy']          = $lang->risk->editedBy;
$config->risk->search['fields']['editedDate']        = $lang->risk->editedDate;

$config->risk->search['params']['name']              = array('operator' => 'include', 'control' => 'input',  'values' => '');
$config->risk->search['params']['project']           = array('operator' => '=', 'control' => 'select', 'values' => '');
...
$config->risk->search['params']['impact']            = array('operator' => '=', 'control' => 'select',  'values' => array('') + $lang->risk->impactList);
$config->risk->search['params']['probability']       = array('operator' => '=', 'control' => 'select',  'values' => array('') + $lang->risk->probabilityList);
$config->risk->search['params']['rate']              = array('operator' => '=', 'control' => 'input',  'values' => '');
$config->risk->search['params']['pri']               = array('operator' => '=', 'control' => 'select',  'values' => array('') + $lang->risk->priList);
...
$config->risk->search['params']['editedBy']          = array('operator' => '=', 'control' => 'select',  'values' => 'users');
$config->risk->search['params']['editedDate']        = array('operator' => '=', 'control' => 'input',  'values' => '', 'class' => 'date');

$config->risk->exportFields = 'id,source,name,execution,category,strategy,status,impact,probability,rate,pri,identifiedDate,plannedClosedDate,actualClosedDate,assignedTo,prevention,remedy,resolution';
