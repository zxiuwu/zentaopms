...
$lang->durationestimation->summary           = $lang->projectCommon . "'規模: <strong class='text-danger'> %s {$lang->hourCommon}</strong>, 估算工作量: <strong id='totalWorkload' class='text-danger'>0</strong>, 總投入人數: <strong id='totalStaff' class='text-danger'>0</strong>";
