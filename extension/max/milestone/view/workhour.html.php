<style>
.workhour-chart .chart-unit {position: absolute; left: 20px; top: 30px;}
</style>
<table class="table table-bordered">
  <thead>
    ...
    <tr>
      ...
      <th title=<?php echo $stage['name'];?>><?php echo $stage['name'];?></th>
      <?php endforeach;?>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      <th>
        <?php echo $lang->milestone->toHours;?>
        <a data-toggle='tooltip' class='text-help' title='<?php echo $lang->milestone->toHoursTip;?>'><i class='icon-help'></i></a>
      </th>
      <?php foreach($workhours as $id => $stage):?>
      <?php if($id == 'count') continue;?>
    ...
    <tr>
      <th>
        <?php echo $lang->milestone->reviewHours;?>
        <a data-toggle='tooltip' class='text-help' title='<?php echo $lang->milestone->reviewHoursTip;?>'><i class='icon-help'></i></a>
      </th>
      <?php foreach($workhours as $id => $stage):?>
      <?php if($id == 'count') continue;?>
...
<div class='cell chart-row'>
  <div class='main-col'>
    <div class='chart-wrapper workhour-chart text-center'>
