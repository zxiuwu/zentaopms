    ...
    <table class='table'>
      ...
      <tbody class='text-center'>
        ...
        <tr>
          ...
          <td>
            <?php
            if(common::hasPriv('report', 'useReport')) echo html::a($this->createLink('report', 'useReport', "reportID=$report->id&from=cmmi", '', true), $lang->report->useReport, '', "data-type='iframe' data-toggle='modal' data-width='90%'");
