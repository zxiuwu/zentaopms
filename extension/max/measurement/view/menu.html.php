...
<?php if(common::hasPriv('measurement', 'browse') and $this->config->db->driver == 'mysql') echo html::a($this->createLink('measurement', 'browse'), '<span class="text">' . $lang->measurement->definition . '</span>', '', "class='btn btn-link browseTab'");?>
