<?php
/**
 * The cancel of opportunity module of ZenTaoPMS.
 *
 * @copyright   Copyright 2009-2021 禅道软件（青岛）有限公司(ZenTao Software (Qingdao) Co., Ltd. www.cnezsoft.com)
 * @license     ZPL(http://zpl.pub/page/zplv12.html) or AGPL(https://www.gnu.org/licenses/agpl-3.0.en.html)
 * @author      Shujie Tian <tianshujie@easycorp.ltd>
 * @package     opportunity
 * @version     $Id: cancel.html.php 4903 2021 14:25:59Z tsj $
...
<div id='mainContent' class='main-content'>
  ...
  <form class='load-indicator main-form' method='post' target='hiddenwin'>
    <table class='table table-form'>
      <tbody>
        <tr>
          <th class='w-120px'><?php echo $lang->opportunity->cancelReason;?></th>
          <td><?php echo html::select('cancelReason', $lang->opportunity->cancelReasonList, '', "class='form-control chosen'");?></td>
        </tr>
        <tr>
