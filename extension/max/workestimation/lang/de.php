...
$lang->workestimation->tips     = 'Estimate the duration of the project only after the estimate of the workload has been completed. The default Estimate Unit, Unit labor cost, Hours/day, Days/week can be configured in <strong>Admin - Model - Common - Estimate</strong>.';
