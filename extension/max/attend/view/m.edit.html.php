<?php
/**
 * The edit mobile view file of attend module of ZDOO.
 *
...
<form class='content box' id='editAttendForm' data-refresh-form='#page' method='post' action='<?php echo $this->createLink('attend', 'edit', "date=$date");?>'>
  <div class='list'>
