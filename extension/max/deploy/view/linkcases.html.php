  ...
  <div class='main-header'>
    <h2>
      ...
      <div class='heading-actions' style='display: inline-block; margin-top: -5px; margin-left: 10px;'>
        ...
        if($suiteList)
        {
            echo "<li>" . html::a(inlink('linkCases', "deployID=$deploy->id&type=all&param=0"), $lang->null) . "</li>";
    ...
    <div class='pull-right btn-toolbar'>
      <?php echo html::linkButton("<i class='icon-back icon-level-up icon-large icon-rotate-270'></i> {$lang->goback}", inlink('cases', "deployID=$deploy->id"), 'self', '', 'btn btn-secondary');?>
    </div>
  </div>
  <div id='queryBox' data-module='testcase' class='show'></div>
