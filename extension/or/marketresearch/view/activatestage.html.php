<?php
/**
 * The activatestage file of marketresearch module of ZenTaoPMS.
 *
...
<div id='mainContent' class='main-content'>
  <div class='main-header'>
    <h2>
      ...
      <?php echo isonlybody() ? ("<span title='$stage->name'>" . $stage->name . '</span>') : html::a($this->createLink('marketresearch', 'stage', 'stageID=' . $stage->id), $stage->name, '_blank');?>
      <?php if(!isonlybody()):?>
      <small><?php echo $lang->arrow . $lang->marketresearch->activateStage;?></small>
      <?php endif;?>
    </h2>
  </div>
    ...
    <table class='table table-form'>
      <tr style='height:50px;'>
        ...
        <td class='muted' colspan='2'>
          <div id='sourceTimeBox'><?php echo $stage->begin . ' ~ ' . $stage->end;?></div>
      ...
      <tr class='hide'>
        <th><?php echo $lang->marketresearch->status;?></th>
        <td><?php echo html::hidden('status', 'doing');?></td>
      </tr>
      <?php $this->printExtendFields($stage, 'table', 'columns=5');?>
      <tr>
        <th><?php echo $lang->comment;?></th>
        <td colspan='5'><?php echo html::textarea('comment', '', "rows='6' class='form-control kindeditor' hidefocus='true'");?></td>
      </tr>
      <tr>
        <td class='text-center form-actions' colspan='6'><?php echo html::submitButton($lang->marketresearch->activateStage) . html::linkButton($lang->goback, $this->session->marketstageList, 'self', '', 'btn btn-wide'); ?></td>
      </tr>
    </table>
  </form>
  <hr class='small' />
