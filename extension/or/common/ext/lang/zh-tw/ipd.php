...
//$lang->demandpool->menu->review  = array('link' => "評審|demand|review|poolID=%s");
//$lang->demandpool->menu->kanban  = array('link' => "看板|demand|kanban|poolID=%s");
//$lang->demandpool->menu->track   = array('link' => "矩陣圖|demand|track|demandID=%s");
...
#$lang->product->menu->initiating  = array('link' => "立項|product|initiating|productID=%s");
...
$lang->charter->menu->failed   = array('link' => "未通過|charter|browse|browseType=failed");
...
$lang->market->menu->research = array('link' => "調研|marketresearch|browse|marketID=%s", 'subModule' => 'marketresearch', 'exclude' => 'marketresearch-reports');
