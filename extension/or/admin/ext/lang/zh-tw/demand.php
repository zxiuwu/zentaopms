<?php
$lang->admin->menuList->feature['subMenu']['demand']  = array('link' => "需求池|custom|required|module=demand", 'exclude' => 'set,required');
$lang->admin->menuList->feature['subMenu']['market']  = array('link' => "市場|custom|set|module=market", 'exclude' => 'set,required');
$lang->admin->menuList->feature['subMenu']['charter'] = array('link' => "立項|custom|set|module=charter", 'exclude' => 'set,required');

$lang->admin->menuList->feature['tabMenu']['demand']['demand']   = array('link' => "需求|custom|required|module=demand&field=priList", 'exclude' => 'custom-set');
$lang->admin->menuList->feature['tabMenu']['charter']['charter'] = array('link' => "立項|custom|set|module=charter&field=charterList", 'exclude' => 'custom-required');
