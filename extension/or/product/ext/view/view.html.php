              ...
              <table class="table table-data">
                <tbody>
                  ...
                  <tr>
                    ...
                    <th><i class="icon icon-person icon-sm"></i> <?php echo $lang->product->PMT;?></th>
                    <td colspan="2"><strong><?php foreach(explode(',', $product->PMT) as $PMT) echo zget($users, $PMT) . "&nbsp;";?></strong></td>
                  </tr>
                  <?php endif;?>
                </tbody>
              </table>
            ...
            <div class="detail-content">
              <table class="table table-data data-basic">
                <tbody>
                  ...
                  <?php $lang->URCommon = common::checkNotCN() ? ' URs' : $lang->URCommon;?>
