<table class="table table-bordered basicInfo">
  <thead>
    <tr>
      ...
      <th rowspan='2' style='overflow: visible;'>
        <?php echo $lang->milestone->stage;?>
        <div class="dropdown dropdown-hover helpDropdown">
          <a data-toggle="dropdown"><i class="icon-help"></i></a>
          <div class="dropdown-menu">
            <?php echo $lang->milestone->milestoneHelpNotice;?>
          </div>
        </div>
      </th>
      <th rowspan='2' style='overflow: visible;'>
        <?php echo $lang->milestone->toNow;?>
        <div class="dropdown dropdown-hover helpDropdown">
          <a data-toggle="dropdown"><i class="icon-help"></i></a>
          <div class="dropdown-menu">
            <?php echo $lang->milestone->soFarHelpNotice;?>
          </div>
        </div>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td rowspan='4' class='text-center'><?php echo $lang->milestone->executionCost;?></td>
