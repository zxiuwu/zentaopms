    ...
    <table class='table table-bordered table-form'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input type='text' name='startDate[]' id='startDate<?php echo $i;?>' value='<?php echo helper::isZeroDate(zget($estimation, 'startDate', '')) ? '' : zget($estimation, 'startDate', '');?>' class='form-control form-date' /></td>
          <td><input type='text' name='endDate[]' id='endDate<?php echo $i;?>' value='<?php echo helper::isZeroDate(zget($estimation, 'endDate', '')) ? '' : zget($estimation, 'endDate', '');?>' class='form-control form-date' /></td>
        </tr>
        <?php $i ++;?>
        <?php endforeach;?>
        <?php endif;?>
