  ...
  <div class='with-padding'>
    <div class="table-row" id='conditions'>
      <form method='post'>
        ...
        <div class='col-sm-5'>
          <div class='input-group input-group-sm'>
            <span class='input-group-addon'><?php echo $lang->pivot->bugResolvedDate;?></span>
    ...
    <div data-ride='table'>
      <table class='table table-condensed table-striped table-bordered table-fixed' id="bugsummary">
        <thead>
          ...
          <th class="w-90px"><?php echo $lang->bug->resolvedBy;?></th>
          ...
          <th class="w-100px"><?php echo $lang->bug->openedDate;?></th>
          <th class="w-80px"><?php echo $lang->bug->resolution;?></th>
          <th class="w-100px"><?php echo $lang->bug->resolvedDate;?></th>
...
<?php endif;?>
<script><?php helper::import('../js/bugsummary/report.js');?></script>
