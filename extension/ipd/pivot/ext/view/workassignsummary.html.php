...
<style>
<?php
helper::import('../css/workassignsummary/report.css');
if($app->getClientLang() == 'zh-cn') helper::import('../css/workassignsummary/report.zh-cn.css');
elseif($app->getClientLang() == 'zh-tw') helper::import('../css/workassignsummary/report.zh-tw.css');
else helper::import('../css/workassignsummary/report.en.css');
?>
</style>
<div class='cell'>
...
<?php endif;?>
<script><?php helper::import('../js/workassignsummary/report.js');?></script>
