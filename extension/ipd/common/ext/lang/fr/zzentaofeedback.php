...
$lang->nonRDMenu->my       = $lang->navIcons['my'] . 'My|my|calendar|';
$lang->nonRDMenu->oa       = $lang->navIcons['oa'] . 'OA|attend|personal|';
$lang->nonRDMenu->feedback = $lang->navIcons['feedback'] . 'Feedback|feedback|browse|';
...
$lang->my->nonRDMenu->effort   = array('link' => "Effort|effort|calendar|", 'subModule' => 'effort', 'alias' => 'effort');
...
$lang->admin->nonRDMenu->group   = array('link' => "Priv Group|group|browse|");

$lang->admin->nonRDMenuOrder[5]  = 'company';
$lang->admin->nonRDMenuOrder[10] = 'group';

$lang->nonRDWebMenu = new stdclass();
$lang->nonRDWebMenu->my       = $lang->navIcons['my'] . 'My|my|calendar|';
$lang->nonRDWebMenu->oa       = $lang->navIcons['oa'] . 'OA|attend|personal|';
$lang->nonRDWebMenu->feedback = $lang->navIcons['feedback'] . 'Feedback|feedback|browse|';
...
if($config->vision == 'lite')
{
    ...
    $lang->feedback->webMenu->unclosed   = array('link' => 'Unclosed|feedback|browse|browseType=unclosed', 'subModule' => 'tree');
    $lang->feedback->webMenu->all        = array('link' => 'All|feedback|browse|browseType=all');
    $lang->feedback->webMenu->public     = array('link' => 'Public|feedback|browse|browseType=public');
