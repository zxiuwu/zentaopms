...
$lang->feedback->menu->browse   = array('link' => '反馈|feedback|admin|browseType=wait', 'alias' => 'create,edit,view,adminview,batchedit,browse,showimport,batchclose');
...
{
    $lang->feedback->menu->browse = array('link' => '反馈|feedback|browse|browseType=unclosed', 'alias' => 'create,edit,view,adminview,batchedit,browse,admin');
