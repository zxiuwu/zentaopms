...
$lang->my->nonRDMenu->effort   = array('link' => "日志|effort|calendar|", 'subModule' => 'effort', 'alias' => 'effort');
...
$lang->admin->nonRDMenu->group   = array('link' => "权限|group|browse|");
...
if($config->vision == 'lite')
{
    ...
    $lang->feedback->webMenu->unclosed   = array('link' => '未关闭|feedback|browse|browseType=unclosed', 'subModule' => 'tree');
    $lang->feedback->webMenu->all        = array('link' => '全部|feedback|browse|browseType=all');
    $lang->feedback->webMenu->public     = array('link' => '公开|feedback|browse|browseType=public');
