      ...
      <tr>
        ...
        <td>
          <div class='input-group'>
            <?php echo html::input('begin', '', "class='form-control form-datetime' placeholder='{$lang->deploy->begin}' data-picker-position='top-right'");?>
            <span class='input-group-addon fix-border'>~</span>
            <?php echo html::input('end', '', "class='form-control form-datetime' placeholder='{$lang->deploy->end}' data-picker-position='top-right'");?>
          </div>
        </td>
      </tr>
      <tr>
