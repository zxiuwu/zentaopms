...
<div id='mainContent' class='main-content'>
  <div class='center-block'>
    <div class='main-header'>
      <h2><?php echo $lang->sqlbuilder->editSQLView;?></h2>
    </div>
      ...
      <table class="table table-form">
        <tbody>
          <tr>
            ...
            <td><?php echo html::input('name', $SQLView->name, "class='form-control'");?></td><td></td>
          </tr>
          <tr>
            <th><?php echo $lang->sqlview->code;?></th>
            <td><?php echo html::input('code', $SQLView->code, "class='form-control' placeholder='{$lang->sqlbuilder->tips->onlyLetter}' disabled='disabled'");?></td><td></td>
          </tr>
          <tr>
            ...
            <td colspan='2'>
              ...
              <?php echo html::textarea('sql', $SQLView->sql, "class='form-control' rows='5'");?>
            </td>
          </tr>
          <tr>
            <th><?php echo $lang->sqlview->desc;?></th>
            <td colspan='2'><?php echo html::textarea('desc', $SQLView->desc, "class='form-control' rows='5'");?></td>
          </tr>
          <tr>
