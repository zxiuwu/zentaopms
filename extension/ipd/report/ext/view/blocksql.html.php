  ...
  <form method='post' action='<?php echo inlink('custom', "step=1&reportID=$reportID&from=$type")?>' target='hiddenwin' class='sqlForm'>
    ...
    <div style='padding: 0 10px 10px;'>
      ...
      if(common::hasPriv('report', 'saveReport'))
      {
          ...
          $attr     = empty($dataList) ? '' : "data-type='iframe' data-toggle='modal'";
          ...
          echo html::a(inlink('saveReport', "reportID=0&step=$step&type=$type&from=$from"), $save, '', "class='btn $disabled' $attr");
          echo '</div>';
      }
      ?>
    </div>
