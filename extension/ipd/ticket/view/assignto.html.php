    ...
    <form method='post' target='hiddenwin'>
      <table class='table table-form'>
        <tr>
          ...
          <td class='w-p25-f'><?php echo html::select('assignedTo', $users, $ticket->assignedTo, "class='form-control chosen'");?></td><td></td>
        </tr>
        <tr>
          <th><?php echo $lang->ticket->left;?></th>
          <td><div class='input-group'><?php echo html::input('left', $ticket->left, "class='form-control'");?> <span class='input-group-addon'><?php echo $lang->ticket->hour;?></span></div></td><td></td>
        </tr>
