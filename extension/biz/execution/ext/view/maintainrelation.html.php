      ...
      <form method='post' class='load-indicator main-form' target='hiddenwin'>
        ...
        <table class='table table-fixed mgb-20 table-form with-border'>
          ...
          <tr class='colhead text-center'>
            ...
            <th class='w-150px'><?php echo $lang->execution->gantt->condition;?></th>
            <th><?php echo $lang->execution->gantt->task;?></th>
            <th class='w-140px'><?php echo $lang->execution->gantt->action;?></th>
          </tr>
          </thead>
          <tbody>
          ...
          ?>
          <tr>
            <td class='text-center'><?php echo $id . html::hidden("id[$id]", "$id");?></td>
            ...
            <td><?php echo html::select("condition[$id]", $lang->execution->gantt->preTaskStatus, $relation->condition, 'class=form-control');?> </td>
            <td style='overflow:visible'><?php echo html::select("task[$id]", $tasksClone, $relation->task, "class='form-control chosen'");?> </td>
            <td><?php echo html::select("action[$id]", $lang->execution->gantt->taskActions, $relation->action, 'class=form-control');?> </td>
          </tr>
          <?php endforeach;?>
          </tbody>
        </table>
        ...
        <table class='table table-form table-fixed with-border'>
          <caption class='text-left'><strong><?php echo $lang->execution->gantt->newCreateRelationOfTasks;?></strong></caption>
          <thead>
          <tr class='colhead text-center'>
            <th class='w-id'><?php echo $lang->execution->gantt->id;?></th>
            <th><?php echo $lang->execution->gantt->pretask;?></th>
          ...
          <tr>
            ...
            <td style='overflow:visible'><?php echo html::select("newpretask[$i]", $undoneTasks, '', "class='form-control chosen' onchange='deleteself(this, $i, \"new\")'");?> </td>
            <td><?php echo html::select("newcondition[$i]", $lang->execution->gantt->preTaskStatus, '', 'class=form-control');?> </td>
            <td style='overflow:visible'><?php echo html::select("newtask[$i]", $undoneTasks, '', "class='form-control chosen'");?> </td>
            <td><?php echo html::select("newaction[$i]", $lang->execution->gantt->taskActions, '', 'class=form-control');?> </td>
          </tr>
          <?php endfor;?>
          </tbody>
          <tfoot>
