...
global $config;
if($config->edition != 'open') $lang->my->menu->effort = array('link' => '日誌|effort|calendar|', 'exclude' => 'my-todo');
...
$lang->execution->menu->kanban    = array('link' => "看板視圖|execution|kanban|executionID=%s");
$lang->execution->menu->task      = array('link' => "列表視圖|execution|task|executionID=%s");
if($config->edition != 'open') $lang->execution->menu->calendar = array('link' => "日曆視圖|execution|calendar|executionID=%s");
if($config->edition != 'open') $lang->execution->menu->gantt    = array('link' => "甘特圖|execution|gantt|executionID=%s");
$lang->execution->menu->tree      = array('link' => "樹狀圖|execution|tree|executionID=%s");
$lang->execution->menu->grouptask = array('link' => "分組視圖|execution|grouptask|executionID=%s");
...
if($config->edition != 'open') $lang->searchObjects['feedback'] = '反饋';
...
$lang->createObjects['story']     = '目標';
$lang->createObjects['task']      = '任務';
$lang->createObjects['execution'] = '任務看板';
