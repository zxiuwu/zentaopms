...
unset($lang->search->modules['trainplan']);
unset($lang->search->modules['opportunity']);
unset($lang->search->modules['risk']);
unset($lang->search->modules['issue']);
unset($lang->search->modules['deploystep']);
unset($lang->search->modules['deploy']);
unset($lang->search->modules['service']);
